...
Use the following ISO 8601 formats for importing [intervals](https://en.wikipedia.org/wiki/ISO_8601#Time_intervals) either as start and end points, or with one time point and a duration:
